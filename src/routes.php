...
return [
  ...
  '~^games/rating/page/(\d+)$~' => [\Gamer\Controllers\GamesController::class, 'ratingPage'],
  '~^games/(.+)/genres$~' => [\Gamer\Controllers\GamesController::class, 'viewByGenre'],
  '~^games/(.+)/genres/page/(\d+)$~' => [\Gamer\Controllers\GamesController::class, 'viewByGenrePage'],
  '~^games/(.+)/platforms$~' => [\Gamer\Controllers\GamesController::class, 'viewByPlatforms'],
  '~^games/(.+)/platforms/page/(\d+)$~' => [\Gamer\Controllers\GamesController::class, 'viewByPlatformsPage'],
  '~^games/(\d+)/year$~' => [\Gamer\Controllers\GamesController::class, 'viewByYear'],
  '~^games/(\d+)/year/page/(\d+)$~' => [\Gamer\Controllers\GamesController::class, 'viewByYearPage'],
  ...
  '~^games/search/page/(\d+)$~' => [\Gamer\Controllers\GamesController::class, 'searchPage'],
  '~^news$~' => [\Gamer\Controllers\NewsController::class, 'viewAll'],
  '~^news/page/(\d+)$~' => [\Gamer\Controllers\NewsController::class, 'page'],
